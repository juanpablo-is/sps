...
ALTER TABLE REPORTE ADD CONSTRAINT CLIENTE_REPORTE FOREIGN KEY (ID_CLIENTE) REFERENCES CLIENTE(ID);

ALTER TABLE REPORTE ADD CONSTRAINT USUARIO_REPORTE FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO(PLACA);