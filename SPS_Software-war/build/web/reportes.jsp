                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div id="reporteIndividual">
                                <h3><b>Nombre: </b>${individual.idUsuario.idPersona.nombre}</h3>
                                <h3><b>Correo: </b>${individual.idUsuario.idPersona.correo}</h3>
                                <h3><b>Placa: </b>${individual.idUsuario.placa}</h3>
                                <h3><b>Marca: </b>${individual.idUsuario.marca}</h3>
                                <hr>
                                <h3><b>Parqueadero: </b>${individual.idCliente.nombre}</h3>
                                <h3><b>Dirección: </b>${individual.idCliente.direccion}</h3>
                                <hr>
                                <h3><b>Fecha reporte: </b>${individual.fecha}</h3>
                                <h3><b>Titulo reporte: </b>${individual.titulo}</h3>
                                <h3><b>Texto reporte: </b>${individual.texto}</h3>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
